...
update ctx msg model =
    ...
    case msg of
        ...
        OnLoadEmojisResponse resp ->
            case resp of
                Ok data ->
                    { model | emojis = Just data } ! []
        ...
        ToggleEmojiKeyboard entry ->
            { model | entryEmojiKeyboard = entry } ! []

        SubmitReaction blockId emojiId ->
            { model | entryEmojiKeyboard = Nothing } ! [ submitReactionCmd ctx blockId emojiId ]

        OnSubmitReactionResponse resp ->
            case resp of
                Ok data ->
                    model ! []
